...
var mewtwo = new Pokemon('two', 100, 80, 25, 'images/characters-front/two.png');
    ...
    setTimeout(function() {
      ...
      if (target.currentHp <= 0) { //Added this in the attack method, else fainted statement happens after counter.
        setTimeout(function() {
          ...
          document.querySelector('.background-music').src = 'audio/108-victory-vs-wild-pokemon-.mp3';
          if (_.any(pokemonArray, function(obj) {
            ...
            setTimeout(function() {
              document.querySelector('.background-music').src = 'audio/145-ending.mp3';
            ...
            setTimeout(function() {
              ...
              setTimeout(function() {
                ...
                document.querySelector('.background-music').src = 'audio/128-battle-vs-gym-leader-.mp3';
                setTimeout(function() {
                  $('.js-player-options, .js-combat-text-container').toggleClass('not-active');
                }, 2000);
              }, 2000);
        ...
        setTimeout(function() { //2sec delay for result
          ...
          setTimeout(function() {
            if (_.every(trainedArray, function(obj) {
              ...
              document.querySelector('.background-music').src = 'audio/117-mt.-moon-cave.mp3';
              $('.combat-text').text('Game Over');
              setTimeout(function() {
                location.reload();
              }, 10000);
